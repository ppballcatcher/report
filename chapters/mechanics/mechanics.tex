...
\label{chap:mechanics}
	...
	\label{sec:mechanics_manufacturing}
		...
		% Rephrase, Anders does not understand. Think that it is meant to be that the plate can hold when a ball hits it
		...
		% Not understood, isn't it just legs are added to mount it on to a plate?
